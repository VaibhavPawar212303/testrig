...
function Timeline() {
  return (
    <>
      <div className="grid grid-cols-3 mt-10 h-10 w-30 ml-96 mr-2 mb-40">
        <ol class="relative border-l border-gray-200 mt-10 ml-20 dark:border-gray-700 float-right col-start-3">
        <h1 className="ml-20 text-xl mb-10">Updates</h1>
          <li class="mb-10 ml-6">
